...
export interface IVerifactionProps {
    ...
    yanzhengma?: string,
    bianState?: any,
    onChangeyan?: (verifaction: string, currentVerifaction: string) => void
}
...
export class Verifaction extends React.Component<IVerifactionProps, IVerifactionState>{
    ...
    onChangeyan(e: any) {
        ...
        if (this.props.onChangeyan)
            this.props.onChangeyan(this.state.yanzheng.toLowerCase(), yan.toLowerCase())
    }
